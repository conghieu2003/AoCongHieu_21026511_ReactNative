...
export default function Screen02({ navigation }) {
  ...
  useFocusEffect(
    useCallback(() => {
      axios
        .get("https://6458c8bc4eb3f674df7d3ce6.mockapi.io/ch/v1/dataset")
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            axios
              .delete(`https://6458c8bc4eb3f674df7d3ce6.mockapi.io/ch/v1/dataset${id}`)
              .then(() => {
    ...
    return (
      <View style={styles.card}>
        ...
        <View style={styles.CRUD}>
          <TouchableOpacity
            onPress={() => navigation.navigate("Screen04", { id: item.id })}
          >
